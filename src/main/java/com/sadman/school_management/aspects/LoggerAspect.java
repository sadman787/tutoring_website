package com.sadman.school_management.aspects;
...
public class LoggerAspect {
    @Around("execution(* com.sadman.school_management..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.sadman.school_management.*.*(..))",throwing = "ex")
